package co.ir.ppaz.vaadin.views.masterdetail2;

import co.ir.ppaz.vaadin.data.entity.SamplePerson;
import co.ir.ppaz.vaadin.data.service.SamplePersonService;
...
@PageTitle("Master-Detail2")
@Route(value = "master-detail2/:samplePersonID?/:action?(edit)")
@AnonymousAllowed
@Tag("master-detail2-view")
@JsModule("./views/masterdetail2/master-detail2-view.ts")
@Uses(Icon.class)
public class MasterDetail2View extends LitTemplate implements HasStyle, BeforeEnterObserver {
    ...
    public MasterDetail2View(SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("master-detail2-view");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(MasterDetail2View.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(MasterDetail2View.class);
            }
        }
    }
